...
import {initHistory, pushState} from './history';
import {fetchData} from './fetch';
import './frontpage/frontpage_view';
import './nav';

var RootView = Marionette.View.extend({
	className: 'root-view',
	template: _.template(`
		<div class="button top-left logo-wrap">
			<svg class="logo" viewBox="0 0 100 35" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
	...
	onToggleMenu: function(){
		this.$el.find('.burger').toggleClass('active');
		this.$el.find('nav').toggleClass('active');
	},
	events: {
		"click .burger": "onToggleMenu"
	},
	onRender: function(){
...
var FrontendApplication = Marionette.Application.extend({
	region: '#wkny',
	onStart: function() {
		this.showView(Root);
		initHistory();
